...
class NotesMod(loader.Module):
    ...
    strings = {"name": "Notes",
               "what_note": "<b>Яку записку потрібно отримати?</b>",
               "no_note": "<b>Примітка не знайдена</b>",
               "save_what": "<b>Ви повинні відповісти на повідомлення, щоб зберегти його в нотатку, або ввести нотатку.</b>",
               "what_name": "<b>Потрібно вказати, як має називатися нотатка?</b>",
               "saved": "<b>Нотатку збережено</b>",
               "notes_header": "<b>Збережені нотатки:</b>\n\n",
               "notes_item": "<b>•</b> <code>{}</code>",
               "delnote_args": "<b>Яку замітку слід видалити?</b>",
               "delnote_done": "<b>Примітку видалено</b>",
               "delnotes_none": "<b>Немає приміток для очищення</b>",
               "delnotes_done": "<b>Усі примітки видалено</b>",
               "notes_none": "<b>Немає збережених нотаток</b>"}
