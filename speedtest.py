...
class SpeedtestMod(loader.Module):
    ...
    strings = {"name": "Speedtest",
               "running": "<b>Запуск тесту інтернета...</b>",
               "results": "<b>Результати:</b>",
               "results_download": "<b>Завантаження:</b> <code>{}</code> <b>MiB/s</b>",
               "results_upload": "<b>Вивантаження:</b> <code>{}</code> <b>MiB/s</b>",
               "results_ping": "<b>Пінг:</b> <code>{}</code> <b>ms</b>"}
